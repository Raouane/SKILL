      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border/50">
        <div className="container py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-foreground">Espace Pro</h1>
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-sm space-y-8 animate-fade-in">
          ...
          <div className="text-center space-y-3">
            ...
            <h2 className="text-2xl font-bold text-foreground">Rejoignez Artisan Connect</h2>
            <p className="text-sm text-muted-foreground">
              Inscrivez-vous ou connectez-vous pour gérer votre profil artisan
            </p>
          </div>
